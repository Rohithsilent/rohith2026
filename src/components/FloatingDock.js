...
const links = [
    ...
    { id: 'github', name: 'GitHub', icon: Github, type: 'external', url: 'https://github.com/Rohithsilent' },
    { id: 'linkedin', name: 'LinkedIn', icon: Linkedin, type: 'external', url: 'https://www.linkedin.com/in/rohith-pullola-253336268/' },
    { id: 'twitter', name: 'X', icon: TwitterXIcon, type: 'external', url: 'https://x.com/RohithP727496' },
