            ...
            <div className="flex flex-col items-center justify-center text-center space-y-12 mb-32">
                ...
                >
                    ...
                    <div className="flex flex-col md:flex-row items-center gap-6">
                        <a
                            href="https://x.com/RohithP727496"
                            target="_blank"
                            className={cn(
                        ...
                        >
                            <SiX className="w-4 h-4 text-foreground transition-transform duration-300 group-hover:scale-110" />
                            <span>Start a conversation</span>
                        </a>

                        <div className="flex items-center gap-4">
                            <a
                                href="mailto:rohithccb0909@gmail.com"
                                className={cn(
                            ...
                            <a
                                href="https://github.com/Rohithsilent"
                                target="_blank"
                                className={cn(
                            ...
                            <a
                                href="https://www.linkedin.com/in/rohith-pullola-253336268/"
                                target="_blank"
                                className={cn(
                                    "rounded-lg bg-white/5 border-2 border-[#e9204f] text-foreground/70 hover:text-foreground hover:bg-white/10 hover:border-white/20 transition-all duration-300 group",
                                    styles.ctaButton
                    ...
                    <h2 className="text-5xl md:text-8xl font-bold tracking-tight leading-[0.9] text-balance pt-8" style={{ fontFamily: 'var(--font-outfit)' }}>
                        Set your <br />
                        <span className="text-accent italic font-light ml-2" style={{ fontFamily: 'var(--font-instrument-serif)' }}>Heart</span> ablaze.
                    </h2>
                </motion.div>
            </div>
